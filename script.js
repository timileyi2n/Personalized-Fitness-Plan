...
function personalizedFitnessPlanner() {
    ...
    let text = ''
    if (fitnessGoals === 'Weight Loss' && fitnessLevels === 'Beginner' && ages >= 18 && ages <= 50) {
            ...
            <p class="font">Monday: Light Cardio</p>
                ...
                <p class="font"> Tuesday: Full-Body Strength</p>
                    ...
                    `
    } else if (fitnessGoals === 'Weight Loss' && fitnessLevels === 'Intermediate' && ages >= 18 && ages <= 50) {
        text = `<h2> Weekly Plans</h2>
        <p class="font">Monday: HIIT Cardio</p>
                 ...
                 <p>2.  Stay hydrated, maintain a calorie deficit, and prioritize protein and whole foods. Progress weekly by increasing intensity or resistance.<p>
                  <p class ="font"> Tips:</p>
                    ...
                    `
    } else if (fitnessGoals === 'Weight Loss' && fitnessLevels === 'Advance' && ages >= 18 && ages <= 50) {
        text = `<h2> Weekly Plans</h2>
        <p class="font"> Monday: HIIT Cardio</p>
               ...
               <p class ="font"> Tips:</p>
                    <p>1. Stay hydrated and stretch after each session.</p>
                       <p>2. Pair with a healthy, calorie-controlled diet.</p>
                          <p>3. Gradually increase intensity weekly.</p>
                `
    } else if (fitnessGoals === 'Muscle Gain' && fitnessLevels === 'Beginner' && ages >= 18 && ages <= 50) {
        text = ` <h2> Weekly Plans</h2>
      ...
      <p>3.  Prioritize sleep and rest days for muscle repair</p>
             `
    } else if (fitnessGoals === 'Muscle Gain' && fitnessLevels === 'Intermediate' && ages >= 18 && ages <= 50) {
        text = `<h2> Weekly Plans</h2>
      ...
      <p>3.  Recovery: Prioritize sleep and rest days for muscle repair</p>
             `
    } else if (fitnessGoals === 'Muscle Gain' && fitnessLevels === 'Advance' && ages >= 18 && ages <= 50) {
        text = `<h2> Weekly Plans</h2>
     ...
     <p> 1.  Overhead press, lateral raises, face pulls, planks, ab rollouts (4 sets of 10–12 reps).<p/>
      ...
      <p>3. Ensure 7–8 hours of sleep daily for recovery.</p>
          `
    } else if (fitnessGoals === 'General Fitness' && fitnessLevels === 'Beginner' && ages >= 18 && ages <= 50) {
        text = `<h2> Weekly Plans</h2>
    ...
    <p class="font">Tips</p>
      ...
      <p>3. Prioritize rest for muscle recovery.</p>
          `
    } else if (fitnessGoals === 'General Fitness' && fitnessLevels === 'Intermediate' && ages >= 18 && ages <= 50) {
        text = `<h2> Weekly Plans</h2>
     <p class="font"> Monday: Full-Body Strength</p>
...
<p class="font">Tips</p>
    ...
    else if (fitnessGoals === 'General Fitness' && fitnessLevels === 'Advance' && ages >= 18 && ages <= 50)  {
        text = `<h2> Weekly Plans</h2>
     <p class="font">  Monday: Full-Body Strength</p>
     ...
     <p class="font">Tips</p>
      ...
      <p>3. Ensure 7–8 hours of sleep daily for recovery.</p>
        ...
        text = "<p style='font-size:1.2rem;'>Low-impact exercises like yoga or swimming are recommended.</p>";
    }
    else {
        text = 'Invalid'
    }
